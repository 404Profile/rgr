    ...
    <MainLayout>
                        ...
                        <div class="pt-10 sm:pt-16 lg:pt-8 lg:pb-14 px-4 sm:px-6 lg:px-8">
                            <div class="text-center lg:text-left">
                                <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                    ...
                                    <span class="block text-indigo-600">{{ $t('home.hero.title2') }}</span>
                                </h1>
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div v-for="category in popularCategories" :key="category.id" class="group relative">
                    ...
                    <div class="mt-4 flex justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">{{ category.products_count }} {{ $t('home.popularCategories.products') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="text-center mt-8">
                <Link :href="route('catalog.index')" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                    {{ $t('home.popularCategories.allCategories') }}
        ...
        <div class="bg-white">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mt-8">
                    <Link :href="route('catalog.index')" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                        {{ $t('home.featuredProducts.toCatalog') }}
                        <ArrowRightIcon class="ml-2 -mr-1 h-5 w-5" aria-hidden="true" />
                    </Link>
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-900">{{ $t('home.advantages.delivery.title') }}</h3>
                        <p class="mt-2 text-base text-gray-500">
                            {{ $t('home.advantages.delivery.description') }}
                        </p>
                    </div>
                    <div class="text-center">
                        <div class="flex justify-center">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-900">{{ $t('home.advantages.quality.title') }}</h3>
                        <p class="mt-2 text-base text-gray-500">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-900">{{ $t('home.advantages.payment.title') }}</h3>
                        <p class="mt-2 text-base text-gray-500">
                            {{ $t('home.advantages.payment.description') }}
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex flex-1 flex-col justify-between bg-white p-6">
                        <div class="flex-1">
                            ...
                            <Link :href="route('news.show', article.slug)" class="mt-2 block">
                                ...
                                <p class="mt-3 text-base text-gray-500 line-clamp-3">{{ article.summary }}</p>
                            </Link>
                        </div>
                        <div class="mt-6">
