    ...
    <MainLayout>
        <div class="max-w-md mx-auto py-12 px-4 sm:px-6">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-extrabold text-gray-900">Регистрация</h1>
                ...
                <div class="mt-6">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white text-gray-500">Или зарегистрироваться через</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                <span class="sr-only">Регистрация через Facebook</span>
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
