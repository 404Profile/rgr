    ...
    <MainLayout>
        <div class="max-w-md mx-auto py-12 px-4 sm:px-6">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-extrabold text-gray-900">Вход в аккаунт</h1>
            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <InputLabel for="remember_me" class="ml-2" value="Запомнить меня" />
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                <span class="sr-only">Войти через Facebook</span>
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
