<template>
    <AdminLayout :title="`Редактирование пользователя: ${user.name}`">
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="px-4 py-4 sm:px-0">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-semibold text-gray-900">Редактирование пользователя: {{ user.name }}</h1>
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    <form @submit.prevent="submit">
                        ...
                        <div class="mb-4">
                            <InputLabel for="password" value="Новый пароль (оставьте пустым, чтобы не менять)" />
                            <TextInput
                                id="password"
